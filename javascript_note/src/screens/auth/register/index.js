...
import '../../../assets/styles/register_screen.scss';
                        ...
                        <div className='orange-gradient-bg principal-card'>                 
                                ...
                                <Form className='nunito'>
                                    ...
                                    <Row>
                                        ...
                                        <Col xs={6}>
                                            <Form.Group className="font-1-5 mb-3" controlId="formBasicEmail">
                                                <Form.Label>Email</Form.Label>
                                                <Form.Control className='card-input' type="email" placeholder="" />
                                            </Form.Group>
                                        </Col>
                                    </Row>
                                    ...
                                    <Row>
                                        ...
                                        <Col xs={6}>
                                            <Form.Group className="font-1-5 text-nowrap mb-3" controlId="formBasicConfirmPassword">
